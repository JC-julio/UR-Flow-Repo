...
import GetAllQueue from "../../Queue/GetByOrganizationId.usecase";
config();
...
test("Deve testar o caso de uso, GetByRegistration", async() => {
    ...
    const getQueue = await getAllQueues.execute({OrganizationId: newLogin.manager.organizationId})
